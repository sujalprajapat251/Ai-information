  ...
  return (
    ...
    <div className="bg-gradient-to-br overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        <div  ref={sliderRef} className="relative w-full max-w-7xl h-96 mb-16" style={{ perspective: '2000px', perspectiveOrigin: 'center center' }} onMouseEnter={() => setIsAutoPlaying(false)} onMouseLeave={() => setIsAutoPlaying(true)}>
          <button onClick={goToPrevious} className="absolute left-8 top-1/2 transform -translate-y-1/2 z-50 group">
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-full p-4 hover:bg-white/20 transition-all duration-300 hover:scale-110 hover:rotate-12">
              <ChevronLeft className="w-8 h-8 text-white group-hover:text-cyan-300 transition-colors" />
            </div>
          </button>
          <button onClick={goToNext} className="absolute right-8 top-1/2 transform -translate-y-1/2 z-50 group">
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-full p-4 hover:bg-white/20 transition-all duration-300 hover:scale-110 hover:-rotate-12">
              <ChevronRight className="w-8 h-8 text-white group-hover:text-cyan-300 transition-colors" />
            </div>
          </button>
              ...
              return (
                <div
                  ...
                  <div className="relative w-full h-full group">
                    <div className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${slide.color} p-1 shadow-2xl`}>
                    ...
                    <div className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${slide.color} opacity-30 blur-xl`} style={{ transform: 'translateZ(-20px) scale(0.9)' }}></div>
                  </div>
                </div>
              );
            })}
