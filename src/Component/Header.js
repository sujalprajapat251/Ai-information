...
const Header = () => {
  ...
  return (
    ...
    <header className="sticky shadow-lg shadow-black py-4 top-0 z-50 border-gray-800 bg-[#060606] text-[#9aa0a6] relative">
      <div className="container mx-auto flex items-center justify-between px-4 sm:px-6">
        <div className="flex items-center space-x-1 text-lg font-medium gap-10">
          <div className='flex items-center space-x-1 text-[#f1f3f4]'>
            ...
            <img src={logo} alt="" className="w-24 h-16 cursor-pointer self-center" />
          </div>
        ...
        <div className="hidden md:flex items-center space-x-3">
          <button className="bg-[rgba(241,243,244,0.08)] font-medium px-3 lg:px-4 py-1.5 rounded-full text-xs sm:text-sm hover:bg-[rgba(241,243,244,0.12)] transition"> <a href="http://yoyoai.ca/">Build with Ai</a></button>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-[#060606] border-t border-gray-800 z-50">
