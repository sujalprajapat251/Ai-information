                   ...
                   <div className="lg:w-1/2 w-full relative overflow-hidden" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
                     ...
                     <div className='lg:w-1/2 w-full bg-[#222222] lg:mt-0  mt-5'>
                         <div className='sm:p-[65px] sx:p-[35px] p-[20px] text-white'>
                            ...
                            <h3 className="text-white text-[22px] sm:text-[32px] md:text-[40px] lg:text-[40px] sm:leading-[46px] leading-[28px] mt-4 md:block hidden" data-aos="fade-left" >Gain practical exposure in <span className='text-themedark'>AI</span> <br></br> research</h3>
